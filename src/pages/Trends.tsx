...
import { TrendingUp, Sparkles, Palette, Shirt, Upload as UploadIcon, X, Ruler } from "lucide-react";
...
export default function Trends() {
  ...
  const canGenerateAnalysis = collectionName && collectionType && products.length > 0;
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Crie análises inteligentes para prever tendências e otimizar suas coleções
          </p>
        </div>
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-display font-medium">Informações da Coleção</h3>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-display font-medium">Upload de Produtos</h3>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-display font-medium">Parâmetros da IA</h3>
              </div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg border bg-card">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Materiais mais buscados</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg border bg-card">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Cortes e silhuetas em alta</p>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-muted-foreground">Balanceada entre velocidade e profundidade</div>
                        </div>
                      </Label>
                    </div>
                    <div>
            ...
            <div className="flex justify-end">
              <Button size="lg" onClick={handleGenerateAnalysis} disabled={!canGenerateAnalysis} className="gap-2">
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-display font-semibold mb-2">Tendências do Mercado</h2>
            <p className="text-muted-foreground">Insights baseados em dados de busca e redes sociais</p>
          </div>
