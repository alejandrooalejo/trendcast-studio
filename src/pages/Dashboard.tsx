...
const recentAnalyses = [{
  ...
  id: 2,
  name: "Linha Premium Casual",
  date: "Há 5 horas",
  status: "concluída"
}, {
  id: 3,
  name: "Análise Fast Fashion",
  date: "Ontem",
  status: "concluída"
}];
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <StatCard title="Tendências identificadas" value="8" icon={TrendingUp} trend={{
          value: 33,
          isPositive: true
        }} delay={0.1} />
          <StatCard title="Produtos em risco" value="3" icon={AlertTriangle} description="Baixa aceitação prevista" delay={0.2} />
          <StatCard title="Precisão média" value="91%" icon={Sparkles} trend={{
          value: 2,
          isPositive: true
        }} delay={0.3} />
        </div>
          ...
          delay: 0.4
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {trendingColors.map((color, index) => <div key={color.name} className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-lg shadow-sm" style={{
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {recentAnalyses.map(analysis => <div key={analysis.id} className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-colors">
